...
for scenario in ['TEMBA_ENB_Carb_High', 'TEMBA_ENB_Carb_Low', 'TEMBA_ENB_EXT_High', 'TEMBA_ENB_Ext_Low', 'TEMBA_ENB_Land_High', 'TEMBA_ENB_Land_Low', 'TEMBA_ENB_ref']:
    # picklefile = sys.argv[1]
    # scenario = sys.argv[2]
    # destination_folder = sys.argv[3]
    # scenario = 'TEMBA_ENB_ref'
    picklefile = f'input_data/{scenario}.pickle'
